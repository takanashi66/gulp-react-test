...
var SClock = function (_React$Component) {
  _inherits(SClock, _React$Component);

  function SClock(props) {
    _classCallCheck(this, SClock);

    var _this = _possibleConstructorReturn(this, (SClock.__proto__ || Object.getPrototypeOf(SClock)).call(this, props));
  ...
  _createClass(SClock, [{
    ...
    value: function render() {
      ...
      var hh = this.fmt(now.getHours());
      var mm = this.fmt(now.getMinutes());
      var ss = this.fmt(now.getSeconds());
...
_reactDom2.default.render(_react2.default.createElement(
  'div',
  null,
  _react2.default.createElement(SClock, null)
